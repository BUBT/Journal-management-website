...
function main()
{
    ...
    foreach ($tids as $key => $value) {
        ...
        // $res[$tags[$key]]['views'] = get_articles_views_under_a_column($value)['views'];
        // $res[$tags[$key]]['subs'] = get_total_of_subscribe_for_a_column($value);
        // $res[$tags[$key]]['articles'] = get_articles_views_under_a_column($value)['num'];
